...
async def load_fresh_messages():
    global last_seen_id
    # БЫЛО 1. Загружать все сообщения каждую секунду (большой трафик)
    # СТАЛО 2. Загружать только новые сообщения
...
async def message_keypress(event):  # срабатываение на Emter
    if event.keyCode == 13:
